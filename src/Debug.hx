...
class Debug {
	...
	static var vertices = new RecycleBuffer<Array<Float>>();
	public static var capsules(default, null) = new RecycleBuffer<CapsuleData>();
...
#else
class Debug {
	public static var capsules(default, never) = new RecycleBuffer<CapsuleData>();
	...
	public static inline function clear_capsules() {}
