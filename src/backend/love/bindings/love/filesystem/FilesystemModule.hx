...
extern class FilesystemModule
{
	...
	public static function getDirectoryItems(dir:String) : Table<Int,String>;
	...
	public static function getInfo(path:String) : FilesystemModuleGetInfoResult;

	public static inline function isFile(path:String) : Bool {
		var info = getInfo(path);
		return info != null && info.type == FileType.File;
	}

	public static function isFused() : Bool;

	public static inline function isSymlink(path:String) : Bool {
		var info = getInfo(path);
		return info != null && info.type == FileType.Symlink;
	}
...
extern typedef FilesystemModuleGetInfoResult = {
	var type : FileType;
	var size : Null<Float>;
	var modtime : Null<Float>;
}
